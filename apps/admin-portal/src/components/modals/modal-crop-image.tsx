...
const ModalCropImage: FC<ModalCropImageProps> = ({ visible = false, image, btnClose, onClose }) => {
  ...
  const uploadCroppedImage = async (croppedAreaPixels: Area | null) => {
    ...
    <Dialog open={visible} modal={true} onOpenChange={onClose}>
      <DialogContent>
        ...
        <DialogFooter>
          ...
          <Button
            onClick={() => {
              uploadCroppedImage(croppedAreaPixelsInfo);
            }}
          >
            {t('btn_done')}
          </Button>
