...
import { CategoriesResponse, CategoryEntity, CategoryFilter, CategoryFormData, CategoryResponse } from '../interfaces/categories.interface';
...
export interface IInitialState extends ReduxBaseState {
  ids: EntityId[];
  entities: { [key: string]: CategoryEntity };
  selected: EntityId[];
  filter?: CategoryFilter;
  detail?: CategoryEntity;
}
...
const slice = createSlice({
  ...
  reducers: {
    ...
    LIST
    *****************************************************************/
    listRequest(state, _action: PayloadAction<{ filter?: CategoryFilter }>) {
      state.isFetching = true;
    },
    listSuccess: (state, action: PayloadAction<CategoriesResponse>) => {
    ...
    *****************************************************************/
    ...
    createSuccess: (state, action: PayloadAction<CategoryResponse>) => {
    ...
    *****************************************************************/
    ...
    readSuccess: (state, action: PayloadAction<CategoryResponse>) => {
    ...
    *****************************************************************/
    ...
    updateSuccess: (state, action: PayloadAction<{ params: unknown; response: CategoryResponse }>) => {
    ...
    *****************************************************************/
    ...
    destroySuccess: (state, action: PayloadAction<CategoryResponse>) => {
    ...
    *****************************************************************/
    ...
    bulkDestroySuccess(state, action: PayloadAction<CategoriesResponse>) {
      const { data, message, statusCode } = action.payload;
