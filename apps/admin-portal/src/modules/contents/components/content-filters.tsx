...
import { CONTENT_STATUSES } from '../constants/contents.constant';

import { useContents } from '../hooks/use-contents';

import ContentFilterStatus from './content-filter-status';

const ContentFilters: FC<ComponentBaseProps> = ({ className }) => {
  ...
  return (
    <div className={classNames('contents-all-filters', className)}>
      <DropdownMenu>
