...
import { ProductEntity, ProductFilter, ProductFormData, ProductResponse, ProductsResponse } from '../interfaces/products.interface';
...
export interface IInitialState extends ReduxBaseState {
  ids: EntityId[];
  entities: { [key: string]: ProductEntity };
  selected: EntityId[];
...
const slice = createSlice({
  ...
  reducers: {
    ...
    LIST
    *****************************************************************/
    listRequest(state, _action: PayloadAction<{ filter?: ProductFilter }>) {
      state.isFetching = true;
    },
    listSuccess: (state, action: PayloadAction<ProductsResponse>) => {
    ...
    *****************************************************************/
    ...
    createSuccess: (state, action: PayloadAction<ProductResponse>) => {
    ...
    *****************************************************************/
    ...
    readSuccess: (state, action: PayloadAction<ProductResponse>) => {
    ...
    *****************************************************************/
    ...
    updateSuccess: (state, action: PayloadAction<{ params: unknown; response: ProductResponse }>) => {
    ...
    *****************************************************************/
    ...
    destroySuccess: (state, action: PayloadAction<ProductResponse>) => {
    ...
    *****************************************************************/
    ...
    bulkDestroySuccess(state, action: PayloadAction<ProductsResponse>) {
      const { data, message, statusCode } = action.payload;
