...
export class Init1724051745888 implements MigrationInterface {
  name = 'Init1724051745888';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "audit_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "record_id" character varying, "old_value" json, "new_value" json, "action" "public"."audit_logs_action_enum" NOT NULL, "table_name" "public"."audit_logs_table_name_enum" NOT NULL, "user_id" uuid, CONSTRAINT "PK_1bb179d048bbc581caa3b013439" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(`CREATE TYPE "public"."products_status_enum" AS ENUM('published', 'draft', 'deleted')`);
    await queryRunner.query(
      `CREATE TABLE "products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "name" character varying(255) NOT NULL, "slug" character varying(255) NOT NULL, "description" character varying(2000), "body" text, "status" "public"."products_status_enum" NOT NULL DEFAULT 'draft', "cover" character varying(1000), "creator_id" uuid, "category_id" uuid, CONSTRAINT "UQ_464f927ae360106b783ed0b4106" UNIQUE ("slug"), CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "posts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "name" character varying(255) NOT NULL, "slug" character varying(255) NOT NULL, "description" character varying(2000), "body" text, "status" "public"."posts_status_enum" NOT NULL DEFAULT 'draft', "cover" character varying(1000), "creator_id" uuid, "category_id" uuid, CONSTRAINT "UQ_54ddf9075260407dcfdd7248577" UNIQUE ("slug"), CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`CREATE TYPE "public"."categories_type_enum" AS ENUM('file', 'product', 'post')`);
    await queryRunner.query(`CREATE TYPE "public"."categories_status_enum" AS ENUM('visibled', 'deleted')`);
    await queryRunner.query(
      `CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "name" character varying NOT NULL, "slug" character varying(255) NOT NULL, "type" "public"."categories_type_enum" NOT NULL DEFAULT 'post', "description" character varying(2000), "body" text, "status" "public"."categories_status_enum" NOT NULL DEFAULT 'visibled', "cover" character varying(1000), "creator_id" uuid, "parent_id" uuid, CONSTRAINT "UQ_420d9f679d41281f282f5bc7d09" UNIQUE ("slug"), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(`CREATE TYPE "public"."files_status_enum" AS ENUM('visibled', 'deleted')`);
    await queryRunner.query(
      `CREATE TABLE "files" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "name" character varying(255) NOT NULL, "unique_name" character varying(255) NOT NULL, "caption" character varying(255), "ext" character varying(5) NOT NULL, "size" bigint NOT NULL, "mime" character varying(50) NOT NULL, "is_temp" boolean NOT NULL DEFAULT true, "status" "public"."files_status_enum" NOT NULL DEFAULT 'visibled', "category_id" uuid, CONSTRAINT "PK_6c16b9093a142e0e7613b04a3d9" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "faqs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "title" character varying(255) NOT NULL, "content" character varying(2000) NOT NULL, "status" "public"."faqs_status_enum" NOT NULL DEFAULT 'draft', CONSTRAINT "PK_2ddf4f2c910f8e8fa2663a67bf0" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(`CREATE TYPE "public"."contents_status_enum" AS ENUM('published', 'draft', 'deleted')`);
    await queryRunner.query(
      `CREATE TABLE "contents" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "name" character varying(255) NOT NULL, "slug" character varying(255) NOT NULL, "description" character varying(2000), "body" text, "type" character varying(50) NOT NULL, "status" "public"."contents_status_enum" NOT NULL DEFAULT 'draft', CONSTRAINT "UQ_8a8cf14dab55b4ebcd93bb536a1" UNIQUE ("slug"), CONSTRAINT "PK_b7c504072e537532d7080c54fac" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(`CREATE TYPE "public"."contacts_status_enum" AS ENUM('visibled', 'deleted')`);
    await queryRunner.query(
      `CREATE TABLE "contacts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "name" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "message" character varying(1000) NOT NULL, "is_read" boolean NOT NULL DEFAULT false, "status" "public"."contacts_status_enum" NOT NULL DEFAULT 'visibled', CONSTRAINT "PK_b99cd40cfd66a99f1571f4f72e6" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
