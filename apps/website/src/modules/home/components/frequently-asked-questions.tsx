...
export const FrequentlyAskedQuestions: FC<ComponentBaseProps> = ({ className }) => {
  return (
    <section id="faq" className={classNames('py-14 sm:py-16', className)}>
      <div className="container">
        ...
        <Accordion type="multiple" className="mt-12 w-full">
          {FAQList.map(({ question, answer, value }: IFAQProps) => (
