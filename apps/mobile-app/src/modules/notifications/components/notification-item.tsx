...
const NotificationItem: FC<NotificationItemProps> = ({ item, onPress }) => {
  ...
  return (
    <Pressable style={[ds.rounded24, ds.px6, ds.py12, dynamicStyles.background(configs.card), !item.isRead && ds.bgPrimary100]} onPress={onPress}>
        ...
        <View style={[ds.shrink]}>
          ...
          <View style={[ds.row, ds.gap8, ds.itemsCenter, ds.mt4]}>
            ...
            <Text fontWeight="Medium" color={configs.accentForeground}>
              {toDateTime(item.createdAt, language)}
            </Text>
          </View>
        </View>
      </View>
