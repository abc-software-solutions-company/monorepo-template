...
const slides: ISlideItem[] = [
  {
    ...
    content: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum in dolorem explicabo distinctio repudiandae!',
  ...
  },
  {
    ...
    content: 'Aperiam expedita distinctio beatae error, impedit iure officiis animi soluta numquam non alias libero fugit',
  },
  {
    id: '3',
        ...
        {slides.map(item => (
          <View key={item.id} style={[ds.relative]}>
            ...
            <View style={[ds.flex1]}>
              <View style={[ds.grow]} />
              <LinearGradient
                colors={['rgba(0, 0, 0, 0)', 'rgba(0, 0, 0, 0.3)', 'rgba(0, 0, 0, 0.5)', 'rgba(0, 0, 0, 0.8)', 'rgba(0, 0, 0, 1)']}
                style={[ds.bottom0]}
              >
                <View style={[ds.pb208, ds.px14]}>
                  <MaskedView maskElement={<Heading fontWeight="Bold" color={Colors.white} text={item.title} style={[ds.textCenter]} />}>
                    <LinearGradient colors={['rgba(255, 255, 255, 0.5)', 'rgba(255, 255, 255, 1)']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }}>
