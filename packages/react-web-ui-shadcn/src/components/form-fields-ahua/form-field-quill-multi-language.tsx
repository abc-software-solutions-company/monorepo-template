...
interface IFormFieldQuillMultiLanguageProps<T extends FieldValues> extends VariantProps<typeof container> {
  dataTestId?: string;
  className?: string;
...
export default function FormFieldQuillMultiLanguage<T extends FieldValues>({
  dataTestId,
  className,
  messageClassName,
  form,
  ...
  minLength = 1,
  maxLength = 255,
}: IFormFieldQuillMultiLanguageProps<T>) {
